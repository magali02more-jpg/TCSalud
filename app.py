...
def login():
    ...
    with col2:
        ...
        st.caption(
            "Usuario de prueba: demo | Contraseña: 1234"
        )
...
def dashboard():
    ...
    # ======================================
        ...
        st.info(
            "El módulo de evoluciones será "
            "desarrollado en la próxima etapa."
        )
